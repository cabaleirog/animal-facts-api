...
from src.api.models.cat import Cat
...
async def cat_fact_id(id: int):  # pylint:disable=invalid-name, redefined-builtin
    """
    Retrieve facts about cats
    """
...
async def cat_add_fact(request: RequestBody):
    """
...
async def cat_delete(id: int):  # pylint:disable=invalid-name, redefined-builtin
    """
