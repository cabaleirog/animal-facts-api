...
ALTER TABLE public.birds OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.birds_id_seq OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.cats OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.cats_id_seq OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.dogs OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.dogs_id_seq OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.foxes OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.foxes_id_seq OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.kangaroos OWNER TO $(ANIMAL_USER);
...
ALTER TABLE public.kangaroos_id_seq OWNER TO $(ANIMAL_USER);
